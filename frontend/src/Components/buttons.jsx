...
import { Box, Button, MenuItem, Select, Typography, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle } from '@mui/material';
import { Link } from 'react-router-dom';
...
const BlueBoxWithButtons = () => {
    return (
        <Box
            ...
            textAlign="center"
        >
            <Button variant="outlined" color="primary" style={{ color: 'blue' }}>
                Generate Referral Link
            </Button>
